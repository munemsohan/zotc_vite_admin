<div class="col-lg-6">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">Zender</h5>

            <label class="aiz-switch aiz-switch-success mb-0">
                <input type="checkbox" onchange='updateSettings(this, "zender")'
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="ZENDER_SITEURL"
                            value="{{ env('ZENDER_SITEURL') }}" placeholder="https://yourzendersite.com" required>
