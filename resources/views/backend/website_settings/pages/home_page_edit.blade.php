				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-slider-target">
							@if (get_business_setting('home_slider_images') != null)
								@foreach (json_decode(get_business_setting('home_slider_images'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <input type="hidden" name="home_slider_images[]" class="selected-files" value="{{ json_decode(get_business_setting('home_slider_images', null, $lang), true)[$key] }}">
					                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="http://" name="home_slider_links[]" value="{{ json_decode(get_business_setting('home_slider_links'), true)[$key] }}">
											</div>
										</div>
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="todays_deal_banner" value="{{ get_business_setting('todays_deal_banner', null, $lang) }}" class="selected-files">
						</div>
					...
					<div class="form-group">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="todays_deal_banner_small" value="{{ get_business_setting('todays_deal_banner_small', null, $lang) }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="#3d4666" name="todays_deal_bg_color" value="{{ get_business_setting('todays_deal_bg_color') }}">
					</div>
					<div class="text-right">
						<button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
					</div>
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-banner1-target">
							@if (get_business_setting('home_banner1_images') != null)
								@foreach (json_decode(get_business_setting('home_banner1_images'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <input type="hidden" name="home_banner1_images[]" class="selected-files" value="{{ json_decode(get_business_setting('home_banner1_images', null, $lang), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="http://" name="home_banner1_links[]" value="{{ json_decode(get_business_setting('home_banner1_links'), true)[$key] }}">
											</div>
										</div>
										@if($lang == $defaultLanguage)
											<div class="col-md-auto">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-banner2-target">
							...
							@if (get_business_setting('home_banner2_images') != null)
								@foreach (json_decode(get_business_setting('home_banner2_images'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <input type="hidden" name="home_banner2_images[]" class="selected-files" value="{{ json_decode(get_business_setting('home_banner2_images', null, $lang), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner2_links">
												<input type="text" class="form-control" placeholder="http://" name="home_banner2_links[]" value="{{ json_decode(get_business_setting('home_banner2_links'), true)[$key] }}">
											</div>
										</div>
										@if($lang == $defaultLanguage)
											<div class="col-md-auto">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-banner3-target">
							...
							@if (get_business_setting('home_banner3_images') != null)
								@foreach (json_decode(get_business_setting('home_banner3_images'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <input type="hidden" name="home_banner3_images[]" class="selected-files" value="{{ json_decode(get_business_setting('home_banner3_images', null, $lang), true)[$key] }}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_banner3_links">
												<input type="text" class="form-control" placeholder="http://" name="home_banner3_links[]" value="{{ json_decode(get_business_setting('home_banner3_links'), true)[$key] }}">
											</div>
										</div>
										@if($lang == $defaultLanguage)
											<div class="col-md-auto">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="input-group" data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="auction_banner_image" class="selected-files" value="{{ get_business_setting('auction_banner_image', null, $lang) }}">
						</div>
						<div class="file-preview box sm">
						</div>
					</div>
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="#292933" name="cupon_background_color" value="{{ get_business_setting('cupon_background_color') }}">
					</div>
					<div class="form-group">
						<label>{{ translate('Title') }}</label>
						<input type="hidden" name="types[]" value="cupon_title">
						<input type="text" class="form-control" placeholder="{{ translate('Title') }}" name="cupon_title" value="{{ get_business_setting('cupon_title') }}">
					</div>
					<div class="form-group">
						<label>{{ translate('Subtitle') }}</label>
						<input type="hidden" name="types[]" value="cupon_subtitle">
						<input type="text" class="form-control" placeholder="{{ translate('Subtitle') }}" name="cupon_subtitle" value="{{ get_business_setting('cupon_subtitle') }}">
					</div>
					<div class="text-right">
						<button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
					</div>
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-categories-target">
							...
							@if (get_business_setting('home_categories') != null)
								@foreach (json_decode(get_business_setting('home_categories'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col">
											<div class="form-group">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="classified_banner_image" value="{{ get_business_setting('classified_banner_image', null, $lang) }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
					<div class="form-group">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="classified_banner_image_small" value="{{ get_business_setting('classified_banner_image_small', null, $lang) }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
					<div class="text-right">
				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-md-10">
							...
							<select name="top_brands[]" class="form-control aiz-selectpicker" multiple data-max-options="12" data-live-search="true" data-selected="{{ get_business_setting('top_brands') }}">
