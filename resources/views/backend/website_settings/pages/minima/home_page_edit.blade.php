										...
										<div class="p-4 border" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group " data-toggle="aizuploader" data-type="image">
													...
													<input type="hidden" name="flash_deal_card_bg_image" value="{{ get_business_setting('flash_deal_card_bg_image', null, $lang) }}" class="selected-files">
												</div>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="{{ translate('Title') }}" name="flash_deal_card_bg_title" value="{{ get_business_setting('flash_deal_card_bg_title', null, $lang) }}">
											</div>
											<!-- Subtitle -->
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="{{ translate('Subtitle') }}" name="flash_deal_card_bg_subtitle" value="{{ get_business_setting('flash_deal_card_bg_subtitle', null, $lang) }}">
											</div>
											<!-- Text Color -->
											<div class="form-group">
												...
												<div class="input-group mb-3 d-flex">
													@php
														$flash_deal_card_text_color = get_business_setting('flash_deal_card_text');
													@endphp
										...
										<div class="p-4 border" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group " data-toggle="aizuploader" data-type="image">
													...
													<input type="hidden" name="todays_deal_card_bg_image" value="{{ get_business_setting('todays_deal_card_bg_image', null, $lang) }}" class="selected-files">
												</div>
												<div class="file-preview box"></div>
											</div>
											<!-- Title -->
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="{{ translate('Title') }}" name="todays_deal_card_bg_title" value="{{ get_business_setting('todays_deal_card_bg_title', null, $lang) }}">
											</div>
											<!-- Subtitle -->
											<div class="form-group">
												<label class="col-from-label fs-13 fw-500">{{ translate('Subtitle') }}</label>
												<input type="hidden" name="types[][{{ $lang }}]" value="todays_deal_card_bg_subtitle">
												<input type="text" class="form-control" placeholder="{{ translate('Subtitle') }}" name="todays_deal_card_bg_subtitle" value="{{ get_business_setting('todays_deal_card_bg_subtitle', null, $lang) }}">
											</div>
											<!-- Text Color -->
											<div class="form-group">
												<label class="col-from-label fs-13 fw-500">{{ translate('Text Color') }}</label>
												<div class="input-group mb-3 d-flex">
													@php
														$todays_deal_card_text_color = get_business_setting('todays_deal_card_text');
													@endphp
										...
										<div class="p-4 border" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group " data-toggle="aizuploader" data-type="image">
													...
													<input type="hidden" name="new_product_card_bg_image" value="{{ get_business_setting('new_product_card_bg_image', null, $lang) }}" class="selected-files">
												</div>
												<div class="file-preview box"></div>
											</div>
											<!-- Title -->
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="{{ translate('Title') }}" name="new_product_card_bg_title" value="{{ get_business_setting('new_product_card_bg_title', null, $lang) }}">
											</div>
											<!-- Subtitle -->
											<div class="form-group">
												<label class="col-from-label fs-13 fw-500">{{ translate('Subtitle') }}</label>
												<input type="hidden" name="types[][{{ $lang }}]" value="new_product_card_bg_subtitle">
												<input type="text" class="form-control" placeholder="{{ translate('Subtitle') }}" name="new_product_card_bg_subtitle" value="{{ get_business_setting('new_product_card_bg_subtitle', null, $lang) }}">
											</div>
											<!-- Text Color -->
											<div class="form-group">
												<label class="col-from-label fs-13 fw-500">{{ translate('Text Color') }}</label>
												<div class="input-group mb-3 d-flex">
													@php
														$new_product_card_text_color = get_business_setting('new_product_card_text');
													@endphp
									...
									<div class="col-lg-6">
										<div class="p-4 border" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3 d-flex">
													@php
														$featured_categories_text_color = get_business_setting('featured_categories_text');
													@endphp
							...
							<div class="bg-white p-3 p-sm-2rem">
								<div class="w-100">
									...
									<div class="home-banner2-target">
										@php 
											$home_banner2_images = get_business_setting('home_banner2_images', null, $lang);
											$home_banner2_links = get_business_setting('home_banner2_links', null, $lang);
										@endphp
							...
							<div class="bg-white p-3 p-sm-2rem">
								<div class="w-100">
									...
									<div class="home-banner3-target">
										@php 
											$home_banner3_images = get_business_setting('home_banner3_images', null, $lang);
											$home_banner3_links = get_business_setting('home_banner3_links', null, $lang);
										@endphp
									...
									<div class="row gutters-16">
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<div class="input-group mb-3">
													@php $coupon_background_color = get_business_setting('cupon_background_color') @endphp
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="{{ translate('Title') }}" name="cupon_title" value="{{ get_business_setting('cupon_title', null, $lang) }}">
											</div>
										</div>
										<!-- Subtitle -->
										<div class="col-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="{{ translate('Subtitle') }}" name="cupon_subtitle" value="{{ get_business_setting('cupon_subtitle', null, $lang) }}">
											</div>
										</div>
									</div>
								</div>
