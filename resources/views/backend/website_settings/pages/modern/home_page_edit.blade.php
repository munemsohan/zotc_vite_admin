                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-md-0">
                                            <label class="col-from-label fs-13 fw-500"><a
                                                    href="https://icons8.com/line-awesome" target="_blank">Line Awesome
                                                    Class</a> (eg,
                                                la
                                                la-truck)</label>
                                            <input type="text" class="form-control" placeholder="Line Awesome Class"
                                                name="four_elements[]"
    ...
    <div class="tab-pane fade" id="sections" role="tabpanel" aria-labelledby="sections-tab">
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Categories and Sliders') }}</h3>
        ...
        <div id="full_slider_div"
            ...
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Full Sliders') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2 mx-0 px-0">
            <div class="col-md-3">
                <div class="d-flex justify-content-between p-2">
                    <h3 class="mb-0 h6 text-center">{{ translate('show_scrolling_text') }}</h3>
                    <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show 4 Element') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Flash Deal') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Todays Deal') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Featured Categories') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Home Banner1 Images') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Home Banner2 Images') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Home Banner3 Images') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Best Selling') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show New Products') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Brands') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="row mt-2">
            <div class="d-flex justify-content-between p-2">
                <h3 class="mb-0 h6 text-center">{{ translate('Show Coupon') }}</h3>
                <label class="aiz-switch aiz-switch-success mb-0">
...
@section('script')
    ...
    <script>
        ...
        function checkStatus(checkbox) {
            if (checkbox.checked) {
                $('#full_slider_div').removeClass('d-none');
            } else {
                $('#full_slider_div').addClass('d-none');
            }
        }
    </script>
@endsection
