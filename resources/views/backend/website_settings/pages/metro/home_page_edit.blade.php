										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control aiz-color-input" placeholder="#000000" name="flash_deal_bg_color" value="{{ get_business_setting('flash_deal_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_business_setting('flash_deal_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
											...
											<div class="form-group d-inline-block">
												<label class="aiz-checkbox">
													...
													<input type="checkbox" class="check-one" name="flash_deal_bg_full_width" value="1" @if(get_business_setting('flash_deal_bg_full_width') == 1) checked @endif>
											...
											<div class="form-group">
												...
												<div class="input-group mb-3 d-flex">
													@php
														$flash_deal_banner_text_color = get_business_setting('flash_deal_banner_menu_text');
													@endphp
										...
										<div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
											...
											<div class="form-group d-inline-block">
												<label class="aiz-checkbox">
													...
													<input type="checkbox" class="check-one" name="todays_deal_section_bg" value="1" @if(get_business_setting('todays_deal_section_bg') == 1) checked @endif>
											...
											<div class="form-group ml-4">
												...
												<div class="input-group mb-3">
													...
													<input type="text" class="form-control aiz-color-input" placeholder="#000000" name="todays_deal_section_bg_color" value="{{ get_business_setting('todays_deal_section_bg_color') }}">
													<div class="input-group-append">
														<span class="input-group-text p-0">
															<input class="aiz-color-picker border-0 size-40px" type="color" value="{{ get_business_setting('todays_deal_section_bg_color') }}">
														</span>
													</div>
												</div>
											</div>
									...
									<div class="col-lg-7">
										<div class="w-100">
											...
											<div class="form-group">
												...
												<div class="input-group mb-3 d-flex">
													@php
														$todays_deal_banner_text_color =  get_business_setting('todays_deal_banner_text_color');
													@endphp
											...
											<div class="form-group">
												...
												<div class="input-group mb-3">
													<div class="input-group" data-toggle="aizuploader" data-type="image">
														...
														<input type="hidden" name="coupon_background_image" class="selected-files" value="{{ get_business_setting('coupon_background_image', null, $lang) }}">
													</div>
													<div class="file-preview box sm">
													</div>
												</div>
