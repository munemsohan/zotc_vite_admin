                    ...
                    <div class="card shadow-none bg-light">
                        ...
                        <div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <!-- Select Footer -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Select Homepage Footer') }}</label>
                                    <div class="col-md-8">
                            ...
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="http://"
                                        name="play_store_link" value="{{ get_business_setting('play_store_link') }}">
                                </div>
                                <!-- App Store Link -->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="http://"
                                        name="app_store_link" value="{{ get_business_setting('app_store_link') }}">
                                </div>
                                <!-- Update Button -->
                                <div class="mt-4 text-right">
                                    <button type="submit"
                            ...
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('Address') }}"
                                        ...
                                        value="{{ get_business_setting('contact_address', null, $lang) }}">
                                </div>
                                <!-- Contact phone -->
                                <div class="form-group">
                            ...
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Widget title"
                                        name="widget_one" value="{{ get_business_setting('widget_one', null, $lang) }}">
                                </div>
                                <!-- Links -->
                                <div class="form-group">
                                        ...
                                        @if (get_business_setting('widget_one_labels', null, $lang) != null)
                                            @foreach (json_decode(get_business_setting('widget_one_labels', null, $lang), true) as $key => $value)
                                                @php
                                                    ...
                                                    if (
                                                        isset(
                                                            json_decode(get_business_setting('widget_one_links'), true)[
                                                                $key
                                                            ],
                                                        )
                                                    ) {
