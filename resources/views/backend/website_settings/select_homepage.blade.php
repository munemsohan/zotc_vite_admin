				...
				<div class="row">
					...
					<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
						<label class="aiz-megabox d-block mb-3">
							<input value="classic" type="radio" name="homepage_select" @if((get_business_setting('homepage_select') == null) || (get_business_setting('homepage_select') == 'classic')) checked @endif>
