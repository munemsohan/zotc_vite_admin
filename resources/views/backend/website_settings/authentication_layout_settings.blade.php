			...
			<div class="row">
				...
				<div class="form-group col-lg-6">
					...
					<div class="input-group" data-toggle="aizuploader" data-type="image">
						...
						<input type="hidden" name="admin_login_page_image" value="{{ get_business_setting('admin_login_page_image') }}" class="selected-files">
					</div>
				...
				<div class="form-group col-lg-6">
					...
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						...
						<input type="hidden" name="customer_login_page_image" value="{{ get_business_setting('customer_login_page_image') }}" class="selected-files">
					</div>
					<div class="file-preview box"></div>
				</div>
				...
				<div class="form-group col-lg-6">
					...
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						...
						<input type="hidden" name="customer_register_page_image" value="{{ get_business_setting('customer_register_page_image') }}" class="selected-files">
					</div>
					<div class="file-preview box"></div>
				</div>
				...
				@if (get_business_setting('vendor_system_activation') == 1)
					...
					<div class="form-group col-lg-6">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="seller_login_page_image" value="{{ get_business_setting('seller_login_page_image') }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
					...
					<div class="form-group col-lg-6">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="seller_register_page_image" value="{{ get_business_setting('seller_register_page_image') }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
				@endif
				...
				@if (addon_is_activated('delivery_boy'))
					...
					<div class="form-group col-lg-6">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="delivery_boy_login_page_image" value="{{ get_business_setting('delivery_boy_login_page_image') }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
				@endif
				...
				<div class="form-group col-lg-6">
					...
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						...
						<input type="hidden" name="forgot_password_page_image" value="{{ get_business_setting('forgot_password_page_image') }}" class="selected-files">
					</div>
					<div class="file-preview box"></div>
				</div>
				...
				<div class="form-group col-lg-6">
					...
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						...
						<input type="hidden" name="password_reset_page_image" value="{{ get_business_setting('password_reset_page_image') }}" class="selected-files">
					</div>
					<div class="file-preview box"></div>
				</div>
				...
				@if (addon_is_activated('otp_system'))
					<div class="form-group col-lg-6">
						...
						<div class="input-group " data-toggle="aizuploader" data-type="image">
							...
							<input type="hidden" name="phone_number_verify_page_image" value="{{ get_business_setting('phone_number_verify_page_image') }}" class="selected-files">
						</div>
						<div class="file-preview box"></div>
					</div>
				@endif
