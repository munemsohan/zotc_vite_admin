                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <select class="form-control aiz-selectpicker" name="homepage_topbar">
                                    <option value="nav"
                                        {{ get_business_setting('homepage_topbar') == 'nav' ? 'selected' : '' }}>Topbar 1
                                    </option>
                                    <option value="nav2"
                                        {{ get_business_setting('homepage_topbar') == 'nav2' ? 'selected' : '' }}>Topbar 2
                                    </option>
                                    <option value="nav3"
                                        {{ get_business_setting('homepage_topbar') == 'nav3' ? 'selected' : '' }}>Topbar 3
                                    </option>
                                    <option value="nav4"
                                        {{ get_business_setting('homepage_topbar') == 'nav4' ? 'selected' : '' }}>Topbar 4
                                    </option>
