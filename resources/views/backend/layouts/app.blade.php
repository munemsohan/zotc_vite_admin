...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ uploaded_asset(get_business_setting('site_icon')) }}">
    <link rel="apple-touch-icon" href="{{ uploaded_asset(get_business_setting('site_icon')) }}">
    <title>{{ get_business_setting('website_name') . ' | ' . get_business_setting('site_motto') }}</title>
...
<body class="">
    ...
    <script src="{{ static_asset('assets/js/admin-vendors.js') }}"></script>
    <script src="{{ static_asset('assets/js/admin-core.js?v=') }}{{ rand(1000, 9999) }}"></script>
