            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="carrier-form">
                        ...
                        <div class="form-group row sandboxhide">
                            <label class="col-md-2 col-from-label">{{ translate('Client ID') }} </label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row sandboxhide">
                            <label class="col-md-2 col-from-label">{{ translate('Client Secret') }} </label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row sandboxhide">
                            <label class="col-md-2 col-from-label">{{ translate('Client Email') }} </label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="client_email"
                                    placeholder="{{ translate('Client Email') }}">
                            </div>
                        </div>
                        <div class="form-group row sandboxhide">
                            <label class="col-md-2 col-from-label">{{ translate('Client password') }} </label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="client_password"
                                    placeholder="{{ translate('Client password') }}">
                            </div>
                        </div>
                        <div class="form-group row">
