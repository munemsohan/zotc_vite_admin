            ...
            <ul class="list-group list-group-flush">
                @forelse ($carts as $key => $cartItem)
                    @php
                        ...
                        $total = $subtotal + $tax + Session::get('seller_pos.shipping', 0) - Session::get('seller_pos.discount', 0);
                    @endphp
    ...
    <div class="col-xl-6">
        <div class="pl-xl-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    @if (Session::has('seller_pos.shipping_info') && Session::get('seller_pos.shipping_info')['name'] != null)
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('Name') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['name'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('Email') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['email'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('Phone') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['phone'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('Address') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['address'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('Country') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['country'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('City') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['city'] }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ translate('Postal Code') }}:</span>
                            <span class="fw-600">{{ Session::get('seller_pos.shipping_info')['postal_code'] }}</span>
                        </div>
                    @else
