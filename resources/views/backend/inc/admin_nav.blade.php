            ...
            <div class="aiz-topbar-item mr-3">
                <div class="d-flex align-items-center">
                    <a class="btn btn-topbar has-transition btn-icon btn-circle btn-light p-0 hov-bg-primary hov-svg-white d-flex align-items-center justify-content-center"
                        href="https://{{ get_domain() }}" target="_blank" data-toggle="tooltip"
                    ...
                    <div class="d-flex align-items-center h-100 dropdown">
                        <a class="dropdown-toggle no-arrow h-100" data-toggle="dropdown" href="javascript:void(0);"
                            ...
                            <span class="btn btn-soft-blue btn-sm d-flex align-items-center rounded-2 hov-svg-white">
                                <span class="fw-500 mx-2 mr-0 d-none d-md-block">New</span>
                    ...
                    <div class="align-items-stretch d-flex dropdown">
                        <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);"
                            ...
                            <span
                                ...
                                data-toggle="tooltip" data-title="All Shops">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#acacac"
                        ...
                        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                            ...
                            @foreach (getAllShops() as $shop)
                                <li class="{{ $currentDomain === $shop->domain ? 'bg-warning' : '' }}">
                                    <a href="{{ url('admin/shop-switch/' . $shop->id) }}" class="dropdown-item">
                                        <span class="text-dark fw-bold">{{ $shop->domain }}</span>
                                    </a>
                                </li>
                            @endforeach
                            <li>
                                <a target="_blank" href="{{ url('admin/main-admin-login') }}" class="dropdown-item">
                                    <span class="fw-500 text-success fw-bold">{{ translate('Add New Shop') }}</span>
                                    <i class="las fs-18 la-plus"></i>
                                </a>
                            </li>
                        </ul>
