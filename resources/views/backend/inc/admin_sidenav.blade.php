        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('pos_system') &&
                    ...
                    @can('pos_manager')
                        @if (!(get_business_setting('vendor_system_activation') && get_business_setting('reseller_system_activation')))
                            <li class="aiz-side-nav-item">
                ...
                @canany(['view_all_orders', 'view_inhouse_orders', 'view_seller_orders', 'view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <!-- Abandoned cart -->
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('abandoned_cart.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"
                                        data-key="abandoned cart">{{ translate('Abandoned Cart') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                @if (get_business_setting('reseller_system_activation') == 1)
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sellers.pending_balances') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text"
                                            data-key="payout request">{{ translate('seller_pending_balance') }}</span>
                                    </a>
                                </li>
                                @endif
