                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="delivery_boy_payment_type" value="salary"
                                        @if (get_business_setting('delivery_boy_payment_type') == 'salary') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="input-group">
                                    <input type="number" name="delivery_boy_salary" class="form-control"
                                        value="{{ get_business_setting('delivery_boy_salary') ? get_business_setting('delivery_boy_salary') : '0' }}">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupPrepend">
                                            {{ \App\Models\Currency::find(get_business_setting('system_default_currency'))->code }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="delivery_boy_payment_type" value="commission"
                                        @if (get_business_setting('delivery_boy_payment_type') == 'commission') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="input-group">
                                    <input type="number" name="delivery_boy_commission" class="form-control"
                                        value="{{ get_business_setting('delivery_boy_commission') ? get_business_setting('delivery_boy_commission') : '0' }}">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupPrepend">
                                            {{ \App\Models\Currency::find(get_business_setting('system_default_currency'))->code }}
                                        </span>
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="delivery_boy_mail_notification" value="1"
                                        @if (get_business_setting('delivery_boy_mail_notification') == '1') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="delivery_boy_otp_notification" value="1"
                                        @if (get_business_setting('delivery_boy_otp_notification') == '1') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10" id="">
                                    ...
                                    <input type="text" class="form-control mb-3" id="longitude"
                                        ...
                                        value="{{ get_business_setting('delivery_pickup_longitude') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-2" id="">
                                ...
                                <div class="col-md-10" id="">
                                    ...
                                    <input type="text" class="form-control mb-3" id="latitude"
                                        ...
                                        value="{{ get_business_setting('delivery_pickup_latitude') }}">
                                </div>
                            </div>
                        @else
                            <div class="form-group row">
...
@section('script')
    ...
    @if (get_business_setting('google_map') == 1)
        <script>
            let default_longtitude = "{{ get_business_setting('google_map_longtitude') }}";
            let default_latitude = "{{ get_business_setting('google_map_latitude') }}";
            ...
            function initialize(lat = -33.8688, lang = 151.2195, id_format = '') {
                ...
                @if (get_business_setting('delivery_pickup_latitude'))
                    long = {{ get_business_setting('delivery_pickup_longitude') }};
                    lat = {{ get_business_setting('delivery_pickup_latitude') }};
                @endif
