...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ asset('public/assets/classic/css/merged.css') }}">
...
<body>
    ...
    <!-- SCRIPTS -->
    <script src="{{ static_asset('assets/classic/js/vendors.js') }}"></script>
    <script src="{{ static_asset('assets/classic/js/core.js?v=') }}{{ rand(1000, 9999) }}"></script>
