<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="media mb-1">
        <img src="{{ static_asset('assets/img/placeholderx200.webp') }}" data-src="{{ uploaded_asset($product->thumbnail_img) }}"
            class="mr-4 lazyload size-90px img-fit rounded-0" alt="Product Image" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholderx200.webp') }}';">
