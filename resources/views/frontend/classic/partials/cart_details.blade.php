                        ...
                        <div class="row">
                                ...
                                <div class="card rounded-0 shadow-none border-0 mb-0">
                                    ...
                                    @if (get_setting('coupon_system') == 1)
                                        @if ($coupon_discount > 0 && $coupon_code)
                                            {{-- <div class="mt-1">
                                                <form class="" id="remove-coupon-form"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button type="button" id="coupon-apply"
                                                                ...
                                                                onclick="couponApply()">{{ translate('Apply') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                            ...
                            <div class="col-6">
                                ...
                                <div class="px-0 py-2 d-flex justify-content-between border-top">
                                    ...
                                    <span class="fw-700 fs-16 text-success"
                                        id="subtotal">{{ single_price($subtotal) }}</span>
                                </div>
                                ...
                                @if ($coupon_discount > 0)
                                    <div class="px-0 py-2 d-flex justify-content-between">
                                        <span
                                            class="opacity-60 fs-14">{{ translate('Coupon Discount') . ' (' . $coupon_code . ')' }}</span>
                                        <span class="fw-700 fs-16 text-danger"> -
                                            {{ single_price($coupon_discount) }}</span>
                                    </div>
                                @endif
    ...
    function couponApply() {
        ...
        $.ajax({
            ...
            success: function(response) {
                AIZ.plugins.notify(response.response_message.response, response.response_message.message);
