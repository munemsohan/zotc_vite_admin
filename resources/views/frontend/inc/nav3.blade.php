...
<div class="row mx-0 top-navbar border-bottom shadow @if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020"
        ...
        <div class="row">
            <div class="col-md-3 d-none d-md-block">
                ...
                <a class="d-block py-1 d-flex align-items-center" href="{{ route('home') }}">
                    ...
                    @else
                        <h2 class="fw-bold text-white">{{ get_setting('website_name') }}</h2>
                    @endif
                </a>
            </div>

            <div class="col-md-2 p-0 d-none d-md-block">
                <div class="d-flex justify-content-between" style="padding-top: 7.5px">
                    <!-- Categoty Menu Button -->
                    <div class="d-none d-xl-block all-category has-transition p-0" id="category-menu-bar">
                        <div class="border border-white text-white rounded h-100 p-2" style="cursor: pointer;">
                            <div class="d-flex align-items-center justify-content-between">
                                <i class="las la-shapes fs-15"></i>
                                <span class="fw-700 ml-1"> {{ translate('Categories') }}</span>
                                <a href="{{ route('categories.all') }}" class="text-reset ml-1">
                                    <small class="d-none d-lg-inline-block hov-opacity-80">
                                        ({{ translate('See All') }})</small>
                                </a>
                                <i class="las la-angle-down has-transition ml-2" id="category-menu-bar-icon"
                                    style="font-size: 1 !important"></i>
                            </div>
                        </div>
                    </div>
                                            ...
                                            @foreach (get_level_zero_categories()->take(10) as $key => $category)
                                                ...
                                                <li class="category-nav-element border border-top-0"
                                                    ...
                                                    <a href="{{ route('products.category', $category->slug) }}"
                                                        class="text-truncate text-dark px-2 fs-14 d-block hov-column-gap-1">
                                                        <img class="cat-image lazyload mr-2 opacity-60"
                                                            src="{{ static_asset('assets/img/placeholderx200.webp') }}"
                                                            data-src="{{ isset($category->catIcon->file_name) ? my_asset($category->catIcon->file_name) : static_asset('assets/img/placeholderx200.webp') }}"
                                                            width="16" alt="{{ $category_name }}"
                                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholderx200.webp') }}';">
                                                        <span
                                                            class="cat-name has-transition">{{ $category_name }}</span>
                                                    </a>

                                                    <div class="sub-cat-menu2 c-scrollbar-light border p-4 shadow-none">
                    ...
                    <button type="button" class="btn btn-sm d-none d-md-block p-0 text-white active"
                        id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="la la-navicon fs-16"></i>
                    </button>
                    <div class="dropdown-menu mt-5" aria-labelledby="dropdownMenuButton">
                        @if (get_setting('header_menu_labels') != null)
                            @foreach (json_decode(get_setting('header_menu_labels'), true) as $key => $value)
                                <a href="{{ json_decode(get_setting('header_menu_links'), true)[$key] }}"
                                    class="dropdown-item fs-13 p-2 d-inline-block fw-700 text-dark header_menu_links hov-bg-black-10
                        ...
                        <a class="d-lg-none mx-3 mt-2" href="{{ route('home') }}">
                            @if ($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-30px h-md-40px" height="40">
                            @else
                                <h5 class="fw-bold text-white">{{ get_setting('website_name') }}</h5>
                            @endif
                        </a>
            ...
            <div class="col-md-4 d-none d-md-block">
                <div class="h-100 d-flex align-items-center justify-content-between">
                    <!-- Compare -->
                    <div class="d-none d-xl-block" id="compare">
                    ...
                    <div class="d-none d-xl-block" id="notification">
                        @if (!isAdmin())
                            <!-- Notifications -->
                        ...
                        <div class="nav-cart-box dropdown h-100" id="cart_items">
                            ...
                            <a href="javascript:void(0)" class="d-flex align-items-center" data-toggle="dropdown"
                                ...
                                <span class="position-relative d-inline-block">
                                    <i class="las la-shopping-cart fs-20 text-white"></i>
                                </span>
                            </a>
                    ...
                    @else
                        <!--Login & Registration -->
                        <span class="d-flex justify-content-center text-white nav-user-info">
                            <a href="{{ route('user.login') }}"
                                class="text-white hov-opacity-100 hov-text-dark fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2">{{ translate('Login') }}</a>
                            <a href="{{ route('user.registration') }}"
                                class="text-white hov-opacity-100 hov-text-dark fs-12 d-inline-block pl-2">{{ translate('Registration') }}</a>
                        </span>
                    @endauth
                    ...
                    @if (get_setting('helpline_number'))
                        ...
                        <a href="tel:{{ get_setting('helpline_number') }}"
                            class="text-secondary fs-12 d-inline-block">
                            {{-- <span>{{ translate('Helpline') }}</span> --}}
                            <span class="text-white d-flex">
                                <i class="la la-phone-volume fs-16 mr-1"></i>
