...
<div
    class="row mx-0 top-navbar border-bottom shadow @if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 p-0 d-none d-md-block">
                <div class="d-flex justify-content-between" style="padding-top: 7.5px">
                    ...
                    <div class="d-none d-xl-block all-category has-transition p-0" id="category-menu-bar">
                        <div class="border border-dark text-dark rounded h-100 p-2" style="cursor: pointer;">
                    ...
                    <button type="button" class="btn btn-sm d-none d-md-block p-0 text-dark active"
                        id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="la la-navicon fs-20"></i>
                    </button>
