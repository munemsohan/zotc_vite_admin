            ...
            <section class="mb-4">
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 gutters-16">
                    ...
                    <div class="col py-3 h-400px h-xl-475px">
                        <a href="{{ route('flash-deal-details', $landing->slug) }}" target="_blank" rel="noopener noreferrer">
                            <div class="h-100 w-100 position-relative hov-scale-img">
                                <div class="position-absolute overflow-hidden h-100 w-100">
                                    {{-- <img src="{{ uploaded_asset($landing->banner) }}" class="img-fit h-100 has-transition"  
                                ...
                                <div class="py-5 px-2 px-lg-3 px-xl-5 absolute-top-left w-100">
                                    <div class="bg-white">
                                        {{-- <div class="aiz-count-down-circle" end-date="{{ date('Y/m/d H:i:s', $landing->end_date) }}"></div> --}}
                                    </div>
                                </div>
                            </div>
                        </a>
