                    ...
                    <div class="aiz-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true'
                        ...
                        @foreach ($photos as $key => $photo)
                            <div class="carousel-box img-zoom rounded-0">
                                <img class="img-fluid lazyload" src="{{ static_asset('assets/img/placeholderx200.webp') }}"
            ...
            <div class="text-left">
                ...
                <div class="mt-3">
                    ...
                    @elseif($qty > 0)
                        ...
                        @else
                            <button type="button" class="btn btn-secondary-base rounded-0 buy-now fw-600 add-to-cart text-white"
                                @if (Auth::check() || get_Setting('guest_checkout_activation') == 1) onclick="addToCart()" @else onclick="showLoginModal()" @endif>
                                <i class="la la-shopping-cart"></i>
                                <span class="d-none d-md-inline-block">{{ translate('Add to cart') }}</span>
                            </button>
                            ...
                            <button type="button"
                                ...
                                @if (Auth::check() || get_Setting('guest_checkout_activation') == 1) onclick="directBuyNow()" @else onclick="showLoginModal()" @endif>
