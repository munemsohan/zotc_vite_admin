                                                            ...
                                                            <div class="col-auto w-60px">
                                                                <div
                                                                    ...
                                                                    <button class="btn col-auto btn-icon btn-sm fs-15"
                                                                        ...
                                                                        data-field="qty-{{ $key }}"
                                                                        @if ($product->digital == 1) disabled @endif>
                                                                        <i class="las la-plus"></i>
                                                                    </button>
    ...
    <div id="addCustomerModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Customer Form -->
                    <form id="customerForm" method="POST" action="{{ route('seller.pos.add_customer') }}">
                        @csrf
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-2 mr-0 pr-0">
                                    <select name="phonecode"
                                        class="form-control rounded-0 border-right-0 no-arrow p-0 text-center">
