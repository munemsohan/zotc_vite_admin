                    ...
                    @if (addon_is_activated('affiliate_system') &&
                        ...
                        <div class="row">
                            @php
                                ...
                                $referral_code_url = str_replace(
                                    '/admin',
                                    '',
                                    URL::to('/aff') . "?code=$referral_code",
                                );
                            @endphp
                            <div class="col mb-2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-700" style="vertical-align: middle;">
                                                @if ($affiliate_log->order_detail_id != null)
                                                    @php
                                                        $url =
                                                            $affiliate_log->order_detail->product->auction_product == 1
                                                                ? route(
                                                                    'auction-product',
                                                                    $affiliate_log->order_detail->product->slug,
                                                                )
                                                                : route(
                                                                    'product',
                                                                    $affiliate_log->order_detail->product->slug,
                                                    ...
                                                    <a href="{{ $url }}" target="_blank"
                                                        title="{{ $affiliate_log->order_detail->product->name }}"
