...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/landing-pages/_next/static/css/25e2d5e4d00fc798.css') }}"
        data-n-g="" />
    <link rel="stylesheet" href="{{ url('public/landing-pages/_next/static/css/1b193c1cc1013192.css') }}"
        data-n-p="" />
...
<body>
    <div id="__next">
        <div class="Landing__1">
            <div class="ChocolateBox StudentPackage">
                        ...
                        <div class="d_flex row">
                            <div class="col-lg-6">
                                <div class="banner_content">
                                    <div class="text">
                                        <h1>ভালোবাসার উপহারটি মূল্যবান হয়। প্রিয়জনের রাগ ভাঙাতে
                                            {{ $landingPage->product->name }} মুহূর্তের মধ্যে প্রিয়জনের মুখে হাসি
                                            ফোটাবে। </h1>
                                        <div class="OrderNow d_flex">
                                            <div class="CallForOrder"><a
                                                    href="{{ $current_url }}#order"><span></span><span></span><span></span><span></span>Order
                                                    Now</a></div>
                            ...
                            <div class="col-lg-6">
                                <div class="banner_img"><img
                                        src="{{ url('public/landing-pages/images/landing-1/banner_img.png') }}"
                                        alt="" /></div>
                            </div>
                        </div>
                    </div>
                </section>
                <section id="delivary" class="DesktopDelivary">
                    <div class="container">
                        <div class="d_flex row">
                            <div class="col-lg-4 col-sm-4">
                                <div class="delivary_item">
                                    <div class="img"><img
                                            src="{{ url('public/landing-pages/images/landing-1/delivary-1.png') }}"
                                            alt="" /></div>
                                    <div class="text">
                                        <h3>সারাদেশে ডেলিভারী চার্জ ফ্রি</h3>
                                    </div>
                                    <div class="delivary_border"><img
                                            src="{{ url('public/landing-pages/images/landing-1/delivary_border.png') }}"
                                            alt="" /></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-4">
                                <div class="delivary_item">
                                    <div class="img"><img
                                            src="{{ url('public/landing-pages/images/landing-1/delivary-2.png') }}"
                                            alt="" /></div>
                                    <div class="text">
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <div class="delivary_item">
                                    <div class="img"><img
                                            src="{{ url('public/landing-pages/images/landing-1/delivary-3.png') }}"
                                            alt="" /></div>
                                    <div class="text">
                    ...
                    <div class="fram"><img src="{{ url('public/landing-pages/images/landing-1/delivary_fram.png') }}"
                            alt="" /></div>
                </section>
                <section id="price">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="price_img"><img
                                        src="{{ url('public/landing-pages/images/landing-1/price_img.png') }}"
                                        alt="" />
                                    <div class="overlay_text">
                                        <h2>আপনার এবং আপনার <br /> প্রিয়জনদের জন্য সেরা উপহার</h2>
                                        <h5>মুল্য-{{ $landingPage->product->unit_price }} টাকা</h5>
                                        <div class="CallForOrder"><a to="form_part" activeclass="active"
                ...
                <section id="customized">
                    <div class="container">
                        <div class="justify-content-md-center row">
                            <div class="col-lg-6">
                                <div class="header">
                                    <h2>{{ $landingPage->product->name }} <br /> কেন কিনবেন?</h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="customized_item">
                                        <div class="customized_border">
                                            <div class="img"><img
                                                    src="{{ url('public/landing-pages/images/landing-1/customize_sign.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="text">
                                                <h3>প্রিয়জনের অভিমান ভাঙ্গাতে</h3>
                                                <p>স্মৃতিময় পুরোনো ছবি দিয়ে সাজিয়ে নিতে পারেন
                                                    {{ $landingPage->product->name }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="section_gaps"></div>
                <section id="customized" class="gallery">
                    <div class="overlay_img"><img
                            src="{{ url('public/landing-pages/images/landing-1/gal_fram.png') }}" alt="" />
                    </div>
                    <div class="container">
                        <div class="justify-content-md-center row">
                            <div class="col-lg-6">
                                <div class="header">
                                    <h2>কি কি থাকছে {{ $landingPage->product->name }}</h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="gallery_item">
                                        <div class="gal_img"><img
                                                src="{{ url('public/landing-pages/images/landing-1/gal-1.png') }}"
                                                alt="" /></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4">
                                    <div class="gallery_item">
                                        <div class="gal_img"><img
                                                src="{{ url('public/landing-pages/images/landing-1/gal-2.png') }}"
                                                alt="" /></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4">
                                    <div class="gallery_item">
                                        <div class="gal_img"><img
                                                src="{{ url('public/landing-pages/images/landing-1/gal-3.png') }}"
                                                alt="" /></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4">
                                    <div class="gallery_item">
                                        <div class="gal_img"><img
                                                src="{{ url('public/landing-pages/images/landing-1/gal-4.png') }}"
                                                alt="" /></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div id="CustomerReviewImg" class="customer-review_CustomerReviewImg__1Fuey">
                                            <img src="{{ url('public/landing-pages/images/customer-review/customer-review1.png') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6">
                                        <div id="CustomerReviewImg" class="customer-review_CustomerReviewImg__1Fuey">
                                            <img src="{{ url('public/landing-pages/images/customer-review/customer-review2.png') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6">
                                        <div id="CustomerReviewImg" class="customer-review_CustomerReviewImg__1Fuey">
                                            <img src="{{ url('public/landing-pages/images/customer-review/customer-review3.png') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6">
                                                                ...
                                                                <label class="aiz-megabox d-block mb-3 border rounded">
                                                                    ...
                                                                    <span class="d-block aiz-megabox-elem p-3">
                                                                        ...
                                                                        <span class="d-block text-center">
                                                                            <span
                                                                                class="d-block fw-bold fs-15">Bkash</span>
                                                                        </span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-4">
                                                                <label class="aiz-megabox d-block mb-3 border rounded">
                                                                    ...
                                                                    <span class="d-block aiz-megabox-elem p-3">
                                                                        ...
                                                                        <span class="d-block text-center">
                                                                            <span
                                                                                class="d-block fw-bold fs-15">Nagad</span>
                                                                        </span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-4">
                                                                <label class="aiz-megabox d-block mb-3 border rounded">
                                                                    ...
                                                                    <span class="d-block aiz-megabox-elem p-3">
                                                                        ...
                                                                        <span class="d-block text-center">
                                                                            <span
                                                                                class="d-block fw-bold fs-15">Paypal</span>
                                                                        </span>
                                                                    </span>
                                                                </label>
                                                            </div>
                                            ...
                                            <div class="col-lg-5">
                                                <div id="OrderConfirmRight" class="order_OrderConfirmRight__9BH89">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <div id="left"
                                                                class="order_left__HNlRT order_d_flex__P2VQu">
                                                        ...
                                                        <li>
                                                            ...
                                                            <h5>
                                                                <div id="checkbox1"
                                                                    ...
                                                                    <input type="radio" id="Inside"
                                                                        name="shipping"
                                                                        value="{{ $landingPage->inside_dhaka }}"
                                                                        checked />
                                                        ...
                                                        <span
                                                            id="orderTotal">{{ $landingPage->product->unit_price }}</button>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="footer4_FooterMainDiv__uWQWn">
                                        <div class="footer4_FooterMainDiv1__i4BvN"><a href="landing-1.html#">
                                        ...
                                        <div class="footer4_FooterMainDiv2__wjIT7"><a href="landing-1.html">
                                                <h4> Privacy Policy</h4>
                                            </a><a href="landing-1.html">
    ...
    <script id="__NEXT_DATA__"
        type="application/json">{"props":{"pageProps":{}},"page":"/landing-1","query":{},"buildId":"8ZCiJa4AZL4bT4qhWltbh","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}</script>
