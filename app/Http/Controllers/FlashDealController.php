...
class FlashDealController extends Controller
{
    ...
    public function flashDealProductDestroy($id)
    {
        $flashDealProduct = FlashDealProduct::findOrFail($id);
        ...
        flash(translate('Flash Deal Product deleted successfully!'))->success();
