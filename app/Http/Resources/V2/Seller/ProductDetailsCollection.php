...
class ProductDetailsCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'short_description'   => $this->getTranslation('short_description', $this->lang),
            'quick_contact'   => $this->getTranslation('quick_contact', $this->lang),
            ...
            "thumbnail_img" => new UploadedFileCollection(Upload::whereIn("id", explode(",", $this->photos))->get()),
