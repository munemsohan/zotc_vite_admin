...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
    ...
    image: "map.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'maps.png">',
...
Vvveb.Components.extend("_base", "widgets/embed-video", {
    ...
    image: "youtube.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'youtube.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
Vvveb.Components.extend("_base", "widgets/facebookcomments", {
    ...
    image: "facebook.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'facebook.svg">',
...
Vvveb.Components.extend("_base", "widgets/instagram", {
    ...
    image: "instagram.svg",
    drophtml: '<img src="' + Vvveb.baseUrl + 'instagram.png">',
...
Vvveb.Components.extend("_base", "widgets/twitter", {
    ...
    image: "twitter.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'twitter.svg">',
...
Vvveb.Components.extend("_base", "widgets/facebookpage", {
    ...
    image: "facebook.svg",
    dropHtml: '<img src="' + Vvveb.baseUrl + 'facebook.png">',
...
Vvveb.Components.extend("_base", "widgets/chartjs", {
    ...
    image: "chart.svg",
	dragHtml: '<img src="' + Vvveb.baseUrl + 'chart.svg">',
