...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('header/menus', 'App\Http\Controllers\Api\V2\HomeCategoryController@headerMenus');
    ...
    Route::name('api.')->group(function () {
        Route::get('navbar', 'App\Http\Controllers\Api\V2\HomeController@navbar')->name('navbar');
        Route::get('homepage', 'App\Http\Controllers\Api\V2\HomeController@homepage')->name('homepage');
        Route::get('landing/{slug}', 'App\Http\Controllers\Api\V2\HomeController@landing')->name('landing');
    });
});
