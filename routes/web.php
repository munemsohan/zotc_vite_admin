...
Route::controller(HomeController::class)->group(function () {
    ...
    //sms buy
    Route::get('smsBuySuccess',  'smsBuySuccess')->name('sms.buy.success');

    //balance buy
    Route::get('balanceBuySuccess',  'balanceBuySuccess')->name('balance.buy.success');

    //plan extend
    Route::get('planExtendSuccess',  'planExtendSuccess')->name('plan.extend.success');

    //plan buy
    Route::get('planBuySuccess',  'planBuySuccess')->name('plan.buy.success');

    //lifetime buy
    Route::get('lifetimePlanBuySuccess',  'lifetimePlanBuySuccess')->name('lifetime.plan.buy.success');
    ...
    // check Custom Domain
    Route::get('checkCustomDomain/{subdomain}',  'checkCustomDomain');
    Route::post('buy-domain-by-gateway',  'buyDomainByGateway');
    ...
    //landing
    Route::get('landing', 'all_landing_pages')->name('landing');
    ...
    Route::get('track', 'trackOrder')->name('orders.track');
});
...
Route::controller(CartController::class)->group(function () {
    Route::get('check-out', 'index')->name('cart');
    ...
    Route::post('cart/productAddtocart', 'productAddtocart')->name('cart.productAddtocart');
    ...
    Route::get('calculate-price/{price}', 'calculatePrice')->name('cart.calculatePrice');
    Route::get('addAddressToCart/{address_id}', 'addAddressToCart')->name('cart.addAddressToCart');
...
Route::controller(PageController::class)->group(function () {
    ...
    //Custom page
    Route::get('page/{slug}', 'show_custom_page')->name('custom-pages.show_custom_page');
});
...
Route::name('landing-pages.')->controller(LandingPageController::class)->group(function () {
    // Landing page routes
    Route::get('{slug}', 'showLandingPage')->name('show_landing_page');
    Route::post('{slug}/order', 'orderLandingPage')->name('order_landing_page');

    Route::prefix('builder')->name('builder.')->group(function () {
        Route::get('getblockscss', 'getBlockCss')->name('getblockscss');
        Route::post('getpagejson', 'getPageJson')->name('getpagejson');
        Route::get('get_products/{slug}', 'getBuilderLandingPageProducts')->name('get_landing_page_products');
    });
});
